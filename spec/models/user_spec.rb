...
describe User do
  ...
  it "should reject invalid email adresses" do
    addresses= %w[user@foo,com user_at.org first.last@foo.]
    addresses.each do |address|
  ...
  it "should reject email addresses identical up to case" do
    upcased_email = @attr[:email].upcase  #"USER@EXAMPLE.COM"
...
describe "authenticate method" do
  ...
  it "should return the user on email address match" do
